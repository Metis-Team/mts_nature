...
def main():
  ...
  Before you run this, you should already have:
    - A properly setup Metis Nature Development Environment
...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the Metis Nature wiki to perform the setup manually.")
    else:
